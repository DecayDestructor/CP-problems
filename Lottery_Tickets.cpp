...
void solve() {
    ...
    if (index > 0 && index < n - 1) {
        ll l = (arr[index] - arr[index - 1]) / 2;
        ll r = (arr[index + 1] - arr[index]) / 2;
        cout
            << l + r + 1 << nl;
    } else if (index == n - 1)
        cout << (arr[index] - arr[index - 1] + 1) / 2 + (ll)1e6 - arr[index] << nl;
    else
        cout << (arr[index + 1] - arr[index]) / 2 + 1 + arr[index] - 1 << nl;
}
int main() {
