...
int n, m, q;
int helper(vi &queries, int m, vector<vi> &seg) {
    // cout << m << nl;
    vi temp;
...
void solve() {
    ...
    while (l <= r) {
        int middle = l + (r - l) / 2;
        int check = helper(queries, middle, seg);
        // cout << middle << " : " << check << nl;
        if (check) {
